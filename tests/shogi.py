...
_TEST_DATA_CASTLES = [
  (1, [Castle.STATIC_ROOK_ANAGUMA], [Castle.HALF_MINO_CASTLE]),
  (2, [], []),
  (3, [Castle.SWINGING_ROOK_ANAGUMA], [Castle.GIRL_IN_THE_HOUSE]),
  (4, [], []),
  ...
  (191, [], []),
  (192, [Castle.HALF_MINO_CASTLE], []),
  (193, [], []),
  (194, [Castle.RIGHT_HAND_YAGURA, Castle.HALF_MINO_CASTLE], []),
  ...
  (220, [], []),
  (221, [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE], []),
  (222, [], []),
  (223, [], []),
  (224, [], []),
  (225, [], []),
  (226, [Castle.SWINGING_ROOK_ANAGUMA], [Castle.SNOW_ROOF_CASTLE]),
  (227, [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE], []),
  (228, [], [Castle.SNOW_ROOF_CASTLE]),
  (229, [Castle.HIGH_MINO_CASTLE], []),
  (230, [], []),
  (231, [], []),
  (232, [Castle.SWINGING_ROOK_ANAGUMA], []),
  (233, [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE], [Castle.ELMO_CASTLE]),
  (234, [Castle.HIGH_MINO_CASTLE], []),
  (235, [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE], [Castle.ELMO_CASTLE]),
  (236, [Castle.BOAT_CASTLE, Castle.MILLENIUM_CASTLE], [Castle.MINO_CASTLE]),
  ...
  (241, [], []),
  (242, [Castle.HALF_MINO_CASTLE, Castle.RIGHT_HAND_YAGURA], [Castle.PEERLESS_GOLDS]),
  (243, [Castle.BOAT_CASTLE], [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE]),
  (244, [], []),
  (245, [], []),
  ...
  (250, [Castle.HALF_MINO_CASTLE, Castle.KIMURA_MINO], []),
  (251, [Castle.BOAT_CASTLE, Castle.BONANZA_CASTLE], [Castle.HALF_MINO_CASTLE]),
  (252, [Castle.BOAT_CASTLE], [Castle.MINO_CASTLE]),
  (253, [], [Castle.MINO_CASTLE]),
  (254, [], []),
  (255, [Castle.ELMO_CASTLE], [Castle.HALF_MINO_CASTLE]),
  (256, [Castle.STATIC_ROOK_ANAGUMA], [Castle.HALF_MINO_CASTLE, Castle.KIMURA_MINO]),
  (257, [], []),
  (258, [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE], [Castle.ELMO_CASTLE]),
  (259, [], [Castle.BOAT_CASTLE]),
  (260, [Castle.HALF_MINO_CASTLE, Castle.KIMURA_MINO], [Castle.CRAB_CASTLE]),
  (261, [], [Castle.BOAT_CASTLE, Castle.STATIC_ROOK_ANAGUMA]),
  (262, [Castle.HALF_MINO_CASTLE], [Castle.ELMO_CASTLE]),
  (263, [], [Castle.GIRL_IN_THE_HOUSE]),
  (264, [], []),
  (265, [Castle.STATIC_ROOK_ANAGUMA], []),
  (266, [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE, Castle.HIGH_MINO_CASTLE], []),
  (267, [Castle.SWINGING_ROOK_ANAGUMA], [Castle.CENTRAL_HOUSE]),
  ...
  (287, [Castle.HALF_MINO_CASTLE, Castle.MINO_CASTLE], [Castle.BOAT_CASTLE, Castle.LEFT_HAND_MINO]),
  (288, [Castle.BONANZA_CASTLE, Castle.HALF_YAGURA], [Castle.HALF_MINO_CASTLE]),
  (289, [], []),
  (290, [], [Castle.HALF_MINO_CASTLE]),
  (291, [], [Castle.YAGURA_CASTLE]),
  (292, [], []),
  (293, [], []),
  (294, [], []),
]
...
_TEST_DATA_OPENINGS = [
  (1, [], []),
  (2, [Opening.GOKIGEN_CENTRAL_ROOK], [Opening.PRIMITIVE_CLIMBING_SILVER]),
  (3, [Opening.GOKIGEN_CENTRAL_ROOK], [Opening.GOKIGEN_CENTRAL_ROOK]),
  ...
  (192, [Opening.OPPOSING_ROOK], []),
  (193, [], [Opening.RIGHT_HAND_FORTH_FILE_ROOK_WITH_LEFT_HAND_MINO]),
  (194, [Opening.OPPOSING_ROOK], []),
  ...
  (220, [Opening.THIRD_FILE_ROOK], [Opening.KIM_KIM_GOLD, Opening.DOUBLE_SWINGING_ROOK]),
  (221, [Opening.QUICK_ISHIDA, Opening.FORTH_FILE_ROOK], [Opening.KIM_KIM_GOLD, Opening.DOUBLE_SWINGING_ROOK]),
  (222, [Opening.YONENAGA_STYLE_RAPID_ENGAGING_YAGURA], [Opening.YAGURA_CENTRAL_ROOK]),
  (223, [], [Opening.UFO_SILVER, Opening.DOUBLE_WING_ATTACK_CLIMBING_SILVER]),
  (224, [], []),
  (225, [Opening.FIRST_FILE_ROOK], [Opening.OPPOSING_ROOK]),
  (226, [Opening.FIRST_FILE_ROOK, Opening.FIRST_FILE_ROOK_ANAGUMA], []),
  (227, [Opening.THIRD_FILE_ROOK], [Opening.RIGHT_HAND_KING]),
  (228, [], [Opening.SILVER_HORNED_SNOW_ROOF]),
  (229, [Opening.QUICK_ISHIDA, Opening.FORTH_FILE_ROOK], [Opening.KIM_KIM_GOLD, Opening.DOUBLE_SWINGING_ROOK]),
  (230, [Opening.URESINO_STYLE], []),
  (231, [], [Opening.PRIMITIVE_CLIMBING_SILVER]),
  (232, [Opening.FIRST_FILE_ROOK, Opening.FIRST_FILE_ROOK_ANAGUMA], [Opening.THIRD_FILE_ROOK]),
  (233, [Opening.THIRD_FILE_ROOK], []),
  (234, [Opening.THIRD_FILE_ROOK], []),
  (235, [Opening.FORTH_FILE_ROOK], []),
  (236, [], [Opening.THIRD_FILE_ROOK]),
  ...
  (242, [Opening.OPPOSING_ROOK], [Opening.DOUBLE_SWINGING_ROOK]),
  (243, [Opening.PAWN45_RAPID_ENGAGEMENT], [Opening.FORTH_FILE_ROOK]),
  (244, [Opening.QUICK_ISHIDA], [Opening.DOUBLE_SWINGING_ROOK, Opening.KIM_KIM_GOLD]),
  ...
  (250, [Opening.SILVER_HORNED_CENTRAL_ROOK], []),
  (251, [], [Opening.OPPOSING_ROOK]),
  (252, [Opening.KING_HEAD_VANGUARD_PAWN], [Opening.FORTH_FILE_ROOK]),
  (253, [Opening.DOUBLE_SWINGING_ROOK, Opening.TAKADA_STYLE_LEFT_HAND_KING], [Opening.FORTH_FILE_ROOK]),
  (254, [], [Opening.MURATA_SYSTEM]),
  (255, [Opening.RIGHT_HAND_FORTH_FILE_ROOK], [Opening.FORTH_FILE_ROOK]),
  (256, [], [Opening.HIDE_CHAN_STYLE_CENTRAL_ROOK, Opening.SILVER_HORNED_CENTRAL_ROOK]),
  (257, [], []),
  (258, [Opening.THIRD_FILE_ROOK], []),
  (259, [Opening.GOKIGEN_CENTRAL_ROOK], []),
  (260, [Opening.GOKIGEN_CENTRAL_ROOK, Opening.SILVER_HORNED_CENTRAL_ROOK], [Opening.PRIMITIVE_CLIMBING_SILVER]),
  (261, [Opening.FORTH_FILE_ROOK, Opening.SWINGING_ROOK_MILLENIUM], [Opening.SWINGING_ROOK_SLOW_GAME_COUNTERMEASURE]),
  (262, [Opening.FORTH_FILE_ROOK], [Opening.RIGHT_HAND_FORTH_FILE_ROOK]),
  (263, [], []),
  (264, [], []),
  (265, [Opening.GOKIGEN_CENTRAL_ROOK, Opening.LEFT_ANAGUMA_CENTRAL_ROOK], [Opening.QUICK_ISHIDA, Opening.DOUBLE_SWINGING_ROOK]),
  (266, [], []),
  (267, [], []),
  ...
  (272, [], [Opening.GOKIGEN_CENTRAL_ROOK]),
  (273, [Opening.SILVER37_SUPER_RAPID], [Opening.GOKIGEN_CENTRAL_ROOK]),
  ...
  (287, [Opening.HIDE_CHAN_STYLE_CENTRAL_ROOK], []),
  (288, [], [Opening.FORTH_FILE_ROOK]),
  (289, [], []),
  (290, [], [Opening.FORTH_FILE_ROOK]),
  (291, [], [Opening.YAGURA_CLIMBING_SILVER]),
  (292, [], [Opening.URESINO_STYLE]),
  (293, [Opening.DOUBLE_WING_ATTACK], [Opening.DOUBLE_WING_ATTACK, Opening.DOUBLE_WING_ATTACK_CLIMBING_SILVER]),
