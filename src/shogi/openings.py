...
Opening = IntEnum('Opening',
  ['OPPOSING_ROOK', 'THIRD_FILE_ROOK', 'FORTH_FILE_ROOK', 'GOKIGEN_CENTRAL_ROOK', 'DOUBLE_SWINGING_ROOK',
   ...
   'SIDE_PAWN_PICKER', 'PAWN23_STRATEGY', 'BISHOP33_STRATEGY', 'KNIGHT33_STRATEGY', 'AONO_STYLE', 'YUUKI_STYLE', 'BISHOP45_STRATEGY', 'ROOK85_STRATEGY',
   'CLIMBING_GOLD', 'CLIMBING_SILVER',
   'SAGINOMIYA_JOSEKI', 'IJIMA_BACK_BISHOP_STRATEGY', 'PAWN45_RAPID_ENGAGEMENT', 'KING_HEAD_VANGUARD_PAWN',
   ...
   'SILVER37_STRATEGY', 'WAKI_SYSTEM', 'MORISHITA_SYSTEM', 'YONENAGA_STYLE_RAPID_ENGAGING_YAGURA', 'NAKAHARA_STYLE_RAPID_ENGAGING_YAGURA', 'YAGURA_CENTRAL_ROOK', 'YAGURA_CLIMBING_SILVER',
...
_OPENINGS_POS_AND_MOVE_D = SFENMap({
  ...
  'lnsgk1snl/1r4g2/p1pppp1pp/6p2/1p5P1/2P6/PP+bPPPP1P/3S3R1/LN1GKGSNL b b 11 2b7g': Opening.BISHOP_EXCHANGE,
  'lnsgk1snl/1r4g2/p1pppp1pp/6p2/1p5P1/2P6/PPSPPPP1P/7R1/LN1GKGSNL w Bb 12 6h7g': Opening.BISHOP_EXCHANGE,
  ...
  'lnsgk1s1l/6gb1/p1ppppn1p/6R2/9/1rP6/P2PPPP1P/1BG6/LNS1KGSNL b 3P2p 17 2a3c': Opening.KNIGHT33_STRATEGY,
...
_RECOGNIZER = Recognizer([
  ([('K', '48'), ('G', '38,58'), ('S', '47'), ('N', '37'), ('L', '19'), ('R', '29') ,
  ...
  ([('B', '77'), ('from', '88'), ('to', '77'), ('K', '78'), ('G', '49,58,67'),
   ('P', '87'), ('P', '76'), ('P', '66,67'), ('P', '56'), ('S', '37,48,57'), ('R', '28'), ('p', '44'), ('p', '34'), ('r', '22,32,42')] +
   last_row_pieces('2345'), Opening.SWINGING_ROOK_SLOW_GAME_COUNTERMEASURE),
  ([('K', '78'), ('B', '88'), ('from', '87'), ('to', '86'), ('R', '28'), ('P', '86'), ('S', '57'), ('G', '58'), ('r', '22,32,42'), ('P', '56'), ('P', '25,26,27'), ('P', '36,37'), ('P', '96,97'), ('P', '76') ]
  ...
  ([('K', '69'), ('G', '78'), ('G', '58'), ('S', '67'), ('S', '47'), ('to', '47'),
    ('P', '76'), ('P', '66'), ('P', '56,57'), ('P', '46'), ('N', '29,37'), ('B', '77,88'), ('P', '25,26')]
   + last_row_pieces('234567')
   ,Opening.SILVER_HORNED_SNOW_ROOF),
  ...
  ([('K', '78'), ('B', '88'), ('G', '58'), ('S', '48'), ('R', '28'), ('N', '37'), ('P', '25'), ('P', '45'), ('to', '45'),
    ('P', '36'), ('P', '76'), ('P', '67'), ('P', '87'), ('r', '42')]
  ...
  ([('K', '69,79,88'), ('S', '26'), ('to', '26'), ('P', '25'), ('R', '28'),
    ('G', '78'), ('S', '67,68,77,88'), ('P', '76'), ('P', '87'), ('B', '46,68,77,79,88'), ('N', '29,37')] +
