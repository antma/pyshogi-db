...
_RECOGNIZER = Recognizer( [
  ...
  ([('K', '28'), ('S', '27'), ('G', '38'), ('N', '37'), ('L', '19'), ('G', '47'),
    ('P', '46'), ('P', '36'), ('P', '26'), ('P', '15,16,17')], Castle.SILVER_CROWN),
  ...
  ([('K', '99'), ('S', '88'), ('G', '78,79,69'), ('L', '98'), ('N', '89'),
...
def position_find_castle(pos: Position) -> Optional[Castle]:
