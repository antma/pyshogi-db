...
_RECOGNIZER = Recognizer( [
  ...
  ([('K', '69'), ('G', '78'), ('G', '58'), ('S', '67'), ('P', '76'), ('P', '66'), ('P', '56,57'), ('N', '89'), ('L', '99'), ('P', '97')], Castle.SNOW_ROOF_CASTLE),
  ...
  ([('G', '58'), ('G', '68'), ('K', '78'), ('S', '77'), ('N', '89'), ('L', '99'),
    ('P', '67'), ('P', '76'), ('P', '87'), ('P', '96,97'), ('to', '68')], Castle.BONANZA_CASTLE),
  ([('G', '58'), ('G', '68'), ('K', '78'), ('S', '77'), ('N', '89'), ('L', '99'),
    ('P', '67'), ('P', '87'), ('P', '96,97'), ('to', '77'), ('from', '88')], Castle.BONANZA_CASTLE),
