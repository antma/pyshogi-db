...
_RECOGNIZER = Recognizer( [
  ...
  ([('K', '28'), ('G', '38'), ('S', '47'), ('L', '19'), ('P', '27'), ('P', '16,17')], 'KIMURA_MINO'),
  ([('base-pattern', 'KIMURA_MINO'), ('N', '29'), ('P', '37'), ('P', '46')], Castle.KIMURA_MINO),
  ([('base-pattern', 'KIMURA_MINO'), ('N', '37'), ('P', '36'), ('!S', '46')], Castle.KIMURA_MINO),
  ([('K', '28,39'), ('S', '38'), ('G', '49'), ('N', '29,37'), ('L', '19'), ('G', '58'),
    ('P', '36,37'), ('P', '27'), ('P', '15,16,17')], Castle.MINO_CASTLE), #('P', '46,47'),
  ...
  ([('G', '67'), ('G', '78'), ('S', '77'), ('K', '99'), ('N', '89'), ('L', '98'),
    ('P', '66'), ('P', '87'), ('P', '96,97')], Castle.YAGURA_ANAGUMA), #('P', '76'),
  ([('G', '67'), ('G', '78'), ('S', '88'), ('K', '89'), ('N', '77'), ('L', '99'),
    ('P', '66'), ('P', '76'), ('P', '87'), ('P', '96,97')], Castle.KIKUSUI_YAGURA),
  ([('G', '67'), ('G', '78'), ('S', '76'), ('K', '88'), ('N', '89'), ('L', '99'),
    ('P', '66'), ('P', '75'), ('P', '86,87'), ('P', '96,97')], Castle.SILVER_STANDING_YAGURA),
  ([('G', '67'), ('G', '78'), ('S', '77'), ('K', '88'), ('N', '89'), ('L', '99'), ('S', '66'),
    ('P', '65'), ('P', '87'), ('P', '96,97')], Castle.DIAMOND_YAGURA), #('P', '76'),
  ([('G', '58'), ('G', '78'), ('S', '68'), ('K', '69'), ('B', '88'), ('N', '89'), ('L', '99'),
    ('P', '56,57'), ('P', '67'), ('P', '76'), ('P', '87'), ('P', '96,97')], Castle.CRAB_CASTLE),
  ([('G', '58'), ('G', '68'), ('K', '78'), ('S', '77'), ('N', '89'), ('L', '99'),
    ('P', '87')], 'BONANZA'),
  ([('base-pattern', 'BONANZA'), ('P', '76'), ('to', '68')], Castle.BONANZA_CASTLE),
  ([('base-pattern', 'BONANZA'), ('P', '67'), ('to', '77'), ('from', '88')], Castle.BONANZA_CASTLE),
